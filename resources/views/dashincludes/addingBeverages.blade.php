								...
								<div class="x_content">
									...
									<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" required="required" value="{{ old('content') }}" class="form-control">Contents</textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="price" class="col-form-label col-md-3 col-sm-3 label-align">Price <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="price" class="form-control" value ="{{ old('price') }}" type="number" name="price" required="required">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" value="{{ old('published') ? 'checked' : '' }}">
												</label>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" value="{{ old('special') ? 'checked' : '' }}">
												</label>
											</div>
										</div>
										<div class="item form-group">
